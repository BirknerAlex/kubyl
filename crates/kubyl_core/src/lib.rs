...
pub use registry::{
    ...
    ColumnWidth, DockPanel, DockPosition, ResourceColumns, SidebarSection, StatusBarItem,
    StatusBarPosition, TabHandle, TabView, Tone, ViewFactory, ViewRegistry, ViewRequest, new_tab,
};
