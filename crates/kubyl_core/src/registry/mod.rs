...
//! | [`ChromeRegistry`] | [`StatusBarItem`], [`DockPanel`], [`SidebarSection`], [`DetailsSection`], [`OverviewSection`] and [`EditNotice`] contributions |
...
pub use chrome::{
    ChromeRegistry, DetailsSection, DockPanel, DockPosition, EditNotice, OverviewSection,
    SidebarSection, StatusBarItem, StatusBarPosition,
};
pub use columns::{
